...
Jest ,in short, is a Javascript testing framework. It not only has a great API, with a well maintaned documentation
...
### coverage
The coverage helps you to see how much 

If you want to see the coverage for the file you are currently 
```npm
